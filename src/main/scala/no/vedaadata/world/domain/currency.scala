...
//	Import av data fra http://www.currency-iso.org/en/home/tables/table-a1.html (XML-format)
...
object CurrencyImporter extends LazyLogging {
  ...
  def fromWeb = fromURL(new URL("http://www.currency-iso.org/dam/downloads/table_a1.xml"))
